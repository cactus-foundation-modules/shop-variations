...
//
// Node cannot load CSS, and the shop's import graph reaches Puck's stylesheet
// through the editor config. Nothing a terminal script does needs a single rule
// out of it, so the honest answer is an empty module rather than a crash.
//
